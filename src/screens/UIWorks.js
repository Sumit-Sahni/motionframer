...
const UIWorks = () => {
  ...
  return (
    <>
    <NavbarComp/>
      <motion.div initial={{y:0, opacity:0}} animate={{ y:0, opacity:1}} transition={{duration:1.3}} exit={{backgroundColor: "#666666", y:-80, opacity:0.2}} className='sm:w-full sm:p-10 sm:h-[90vh] flex flex-col lg:flex-row items-center justify-center p-10'>
