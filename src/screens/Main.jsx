        ...
        {/* MY INTRO  */}
         <div className='h-[80vh] sm:h-auto lg:h-[90vh] w-full sm:w-2/3 mx-auto py-16 px-2 md:px-16 mt-24 '>
            ...
            <div className='p-2 w-full sm:w-full md:w-3/5 sm:py-4 sm:px-3'>
                ...
                className='text-gray-400 sm:text-xl'>I'm a software developer student specializing in Web-dev and problem solving. Currently, I'm focused on learning Typescript & Web Apps</motion.p>
            </div>
