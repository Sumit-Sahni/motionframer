     ...
     <section className='h-auto md:h-[385vh] bg-[#0a192f] absolute '>
        {/* MY INTRO  */}
         <div className='sm:h-[70vh] md:h-[100vh] w-full sm:w-2/3 mx-auto py-16 px-2 md:px-16 mt-24'>
           ...
           {/* ABOUT ME  */}
          <div className='sm:h-auto w-full sm:w-3/4 mx-auto py-16 sm:py-0  px-2 sm:px-16'>
             ...
             <div className='w-full h-full flex flex-col md:flex-row'>
                ...
                <div className='md:w-[50%]'>  
                 <div
                  ...
                  <div className='w-full sm:w-[80%] mx-auto lg:w-[50%] flex flex-col items-center lg:items-end py-10 '>
           ...
           <div className='h-auto md:h-[60vh] w-full sm:w-3/4 mx-auto  px-2 sm:px-24'> 
            ...
            <div className='w-full h-full flex flex-col md:flex-row'>
               <div className='md:w-[30%] border-l-2 h-48 border-gray-600'>  
                 ...
                 <div className='w-full py-12 sm:py-0 sm:w-[80%] mx-auto lg:w-[70%] flex flex-col px-4 md:px-10 '>
                               {
                                (toggle?
                                 <motion.div
