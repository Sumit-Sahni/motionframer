        ...
        <div className='sm:h-auto w-full md:w-3/4 mx-auto sm:py-10 md:py-16   px-2 sm:px-16'>
          ...
          <div className='w-full h-full flex flex-col md:flex-row'>
            <motion.div
              ...
              <div className=' border-l-2 h-full my-auto sm:h-96 sm:mt-8 border-gray-600 absolute'></div>
              <div className='p-4 text-gray-400  '>
                ...
                <h1>
                  <span className='w-96 '>
                    <p>I aim towards combining my learnings to integrate diverse perspectives and a collaborative approach to the product innovation process.</p>
                  </span>
                </h1>
              </div>
            </motion.div>
          ...
          <div className='w-full h-full flex flex-col md:flex-row'>
            <div className='md:w-[30%] border-l-2 h-48 border-gray-600'>
              <div onClick={HandleClick} className='cursor-pointer w-full hover:bg-[#142540] delay-100 duration-300 hover:border-[#64ffda] hover:border-l-2'>
                <div className='p-4'>
                  <h1 className='text-xl text-gray-500'>Web App's</h1>
                </div>
              </div>
          ...
          <div className='w-full md:w-3/4 mx-auto flex flex-col items-center justify-center'>
            ...
            <div className='w-full sm:w-4/5 text-center p-8'>
              <p className='text-white'>
                I am constantly looking for new opportunities in industry, I am willing to work in the field of software applications<br />
