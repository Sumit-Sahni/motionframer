  ...
  return (
        ...
        className='w-full h-[80px] z-10  sticky'>
          <div className='px-12 flex justify-between items-center w-full h-full'>
             <motion.div initial={{x:-100}} animate={{x:0}} transition={{ delay:3, duration:1}} className='flex items-center'>
                 <h1 className='text-3xl lg:text-4xl font-bold mr-4 '><img src={Logo} alt='logo' width={40}></img> </h1>
             </motion.div>
              <motion.ul  initial={{opacity:0}} animate={{opacity:1}} transition={{delay:1, duration:1}} className='hidden md:flex items-center text-xl font-light '>
                 <li><Link className='cursor-pointer ' to="book" spy={true} smooth={true} offset={10} duration={700}><NavLink to='/books'>Project</NavLink></Link></li>
